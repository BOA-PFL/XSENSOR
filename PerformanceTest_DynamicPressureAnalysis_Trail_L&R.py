...
# Overall pressure plots for Altra
plt.figure(figsize = (15,8))
plt.subplot(2,3,1)
plt.plot(toeF1[:,27:])
plt.ylim((0,2000))
plt.xlim((0,100))
plt.ylabel('Toe Region Force (N)')
plt.title('Uphill')
...
plt.xlim((0,100))
plt.title('Downhill')
plt.legend(['Carbon Fiber','D30','Original'])    
...
plt.xlim((0,100))
plt.xlabel('% Stance')
plt.ylabel('Forefoot Region Force (N)')
...
plt.ylim((0,1500))
plt.xlim((0,100))
plt.ylabel('Midfoot Region Force (N)')
plt.title('Uphill')
...
plt.xlim((0,100))
plt.xlabel('% Stance')
plt.ylabel('Heel Region Force (N)')
