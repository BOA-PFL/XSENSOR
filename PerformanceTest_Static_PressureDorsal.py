...
fPath = 'C:\\Users\\bethany.kilpatrick\\Boa Technology Inc\\PFL - General\\Testing Segments\\AgilityPerformanceData\\AS_Train_TongueDialLocationII_Mech_Jan23\\Xsensor\\StaticSitting\\'
fileExt = r".csv"
...
for entry in entries:
    ...
    if answer == True:
        ...
        outfileName = fPath + 'CompiledStaticResults.csv'
        if save_on == 1:
